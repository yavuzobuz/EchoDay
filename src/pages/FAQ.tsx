...
const FAQ: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[hsl(var(--gradient-from))] via-[hsl(var(--gradient-via))] to-[hsl(var(--gradient-to))]">
      ...
      {/* Footer */}
      <footer className="bg-white/10 dark:bg-gray-900/30 backdrop-blur-xl border-t border-white/20 dark:border-gray-700/50 mt-20">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex items-center gap-4">
                {/* Social Links */}
                <a href="https://github.com/echoday" className="p-2 rounded-lg bg-white/10 dark:bg-gray-800/30 hover:bg-white/20 dark:hover:bg-white/10 transition-colors">
                ...
                <a href="https://twitter.com/echoday" className="p-2 rounded-lg bg-white/10 dark:bg-gray-800/30 hover:bg-white/20 dark:hover:bg-white/10 transition-colors">
                  <svg className="w-5 h-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                  </svg>
                </a>
                <a href="https://discord.gg/echoday" className="p-2 rounded-lg bg-white/10 dark:bg-gray-800/30 hover:bg-white/20 dark:hover:bg-white/10 transition-colors">
                  <svg className="w-5 h-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-semibold text-[hsl(var(--foreground))] mb-4">{t('footer.quickLinks', 'Hızlı Bağlantılar')}</h3>
              <ul className="space-y-2">
                <li>
                  <button onClick={() => navigate('/')} className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
                    {t('footer.home', 'Ana Sayfa')}
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/pricing')} className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
                    {t('footer.pricing', 'Fiyatlandırma')}
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/app')} className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
                    {t('footer.app', 'Uygulamayı Başlat')}
                  </button>
                </li>
                <li>
                  <a href="https://github.com/echoday/docs" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
            ...
            {/* Support */}
            <div>
              <h3 className="font-semibold text-[hsl(var(--foreground))] mb-4">{t('footer.support', 'Destek')}</h3>
              <ul className="space-y-2">
                <li>
                  <button onClick={() => navigate('/faq')} className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
                    {t('footer.faq', 'SSS')}
                  </button>
                </li>
                <li>
                  <a href="mailto:support@echoday.com" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
                    {t('footer.contact', 'İletişim')}
                  </a>
                </li>
                <li>
                  <a href="/privacy" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
                    {t('footer.privacy', 'Gizlilik Politikası')}
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition-colors">
          ...
          {/* Bottom Bar */}
          <div className="mt-8 pt-8 border-t border-white/10 dark:border-gray-700/30 text-center">
            <p className="text-sm text-[hsl(var(--muted-foreground))]">
              © 2024 EchoDay. {t('footer.rights', 'Tüm hakları saklıdır.')}
            </p>
            <p className="text-xs text-[hsl(var(--muted-foreground))] mt-2">
              {t('footer.madeWith', 'Made with')} ❤️ {t('footer.by', 'by EchoDay Team')}
            </p>
          </div>
        </div>
      </footer>
