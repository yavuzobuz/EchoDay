...
{top3.map(todo => (
                      <button onClick={() => openAgenda(d)} key={todo.id} className="flex items-center gap-1 text-[11px] truncate w-full text-left hover:bg-gray-100 dark:hover:bg-gray-800 rounded px-0.5">
                        <span className={`h-2 w-2 rounded-full ${priorityClasses[todo.priority]}`}></span>
