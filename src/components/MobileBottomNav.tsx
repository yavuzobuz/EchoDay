  ...
  return (
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-50 safe-area-inset-bottom md:hidden">
      <div className="grid grid-cols-5 h-16">
        ...
        {/* Image Task - FAB style in center */}
        <button
          onClick={onImageTask}
          disabled={isListening}
          className="flex flex-col items-center justify-center -mt-6 disabled:opacity-50"
        >
          <div className="bg-[var(--accent-color-600)] hover:bg-[var(--accent-color-700)] active:scale-95 rounded-full h-14 w-14 flex items-center justify-center shadow-lg text-white transition-all">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-7 w-7"
              viewBox="0 0 24 24"
